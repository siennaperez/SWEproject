...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await axios.post('http://10.138.217.191:3000/login', { username: email, password });
  ...
  const updateProfile = async () => {
    try {
      ...
      await axios.put('http://10.138.217.191:3000/profile', { name, bio, profilePhoto }, {
        headers: {
