...
app.put('/user', async (req, res) => {
  try {
    ...
    const userId = req.userId; // Assuming you have middleware that sets req.userId after authentication
    const user = await User.findByIdAndUpdate(userId, { displayName, bio, profilePhoto }, { new: true });
